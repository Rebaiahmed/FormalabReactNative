...
_pickDocument = async () => {
  ...
  //_____make upload here______________//
}
...
goFiles =(docname) =>{
  this.props.navigation.navigate('Files',{'docname':docname});
}
    ...
    renderCard(user, index) {
        ...
        return (
          <TouchableOpacity  onPress={() =>this.goFiles('Document One')}>
          <View
            key={index}
            style={{
              height: 60,
